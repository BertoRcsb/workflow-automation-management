...
> lá: skill é instrução executável, não backlog). Toda mudança de skill/comando = **só com OK do Ronan**.
...
- Refino do falso-positivo de `parse_failed` para placeholders sem inlineCard ("APENAS PROC"/"N/A")
  — aplicar só após concluir a 1.120.0, com OK do Ronan.
...
- Estudar (com o Ronan) se um dia o Optimus poderá mergear/deployar com segurança.
...
- Integração com CI/CD (hoje manual via Ronan).
